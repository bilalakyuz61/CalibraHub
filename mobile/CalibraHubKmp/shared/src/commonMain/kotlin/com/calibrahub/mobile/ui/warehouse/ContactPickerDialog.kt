...
/**
 * Cari rehberi — tam ekran arama/gözat diyaloğu. CalibraHubAndroid
 * `ui/warehouse/ContactPickerDialog.kt` ile BİREBİR sadık port. [ContactPickerField]'ın
 * type-ahead dropdown'ının YANINDA duran "rehber" butonundan açılır (DeliveryScreen). Aynı arama
 * sözleşmesini (contacts/search) kullanır ama sonucu küçük bir dropdown yerine tam ekran
 * kaydırılabilir listede gösterir.
 *
 * State hoisting YOK — bu diyalog kendi arama state'ini kendi yönetir; yalnız nihai seçim
 * [onSelected] ile dışarı bildirilir.
 */
