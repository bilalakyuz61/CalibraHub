...
import com.calibrahub.mobile.data.DraftInventoryCountDto
import com.calibrahub.mobile.session.SessionManager
import kotlinx.coroutines.launch

/**
 * Taslak Sayımlar → Yansıt — CalibraHubAndroid `ui/warehouse/DraftCountsScreen.kt` ile BİREBİR
 * sadık port. Liste GET inventory-counts (applied=false kalmış belgeler) — Yansıt aksiyonu MEVCUT
 * [com.calibrahub.mobile.data.WarehouseRepository.applyInventoryCount] fonksiyonunu aynen çağırır.
 *
...
@Composable
fun DraftCountsScreen(session: SessionManager, onBack: () -> Unit) {
