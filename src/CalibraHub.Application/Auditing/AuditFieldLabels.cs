...
public static class AuditFieldLabels
{
    ...
    public static readonly IReadOnlyDictionary<string, string> EntityLabels =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ShiftScenario"]         = "Vardiya Senaryosu",
            ["ScenarioMachineShift"]  = "Senaryo Makine-Vardiya Ataması",
            ["Bom"]            = "Ürün Ağacı",
            ...
            ["QualityInspectionPlan"] = "Muayene Planı",
            ["QualityDefectCode"]     = "Hata Kodu",
            ["Capa"]                  = "DÖF",
            ["CapaAction"]            = "DÖF Aksiyonu",
    ...
    private static readonly Dictionary<string, string> FieldLabels =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Kalite muayene alanları
            ["InspectionType"] = "Muayene Tipi",
            ["Verdict"] = "Karar",
            ["Disposition"] = "Uygunsuzluk Kararı",
            ["CharacteristicName"] = "Karakteristik",
            ["Nominal"] = "Nominal",
            ["LowerTol"] = "Alt Tolerans",
            ["UpperTol"] = "Üst Tolerans",
            ["Measured"] = "Ölçülen",
            ["Result"] = "Sonuç",
            ["DefectCodeId"] = "Hata Kodu",
            ["InspectedByPersonnelId"] = "Muayene Eden",
            ["InspectedAt"] = "Muayene Zamanı",
            ["TemplateLineId"] = "Şablon Satırı",
            // DÖF (CAPA) alanları
            ["CapaType"] = "DÖF Türü",
            ["ProblemDescription"] = "Problem Tanımı",
            ["RootCauseMethod"] = "Kök Neden Yöntemi",
            ["RootCause"] = "Kök Neden",
            ["Severity"] = "Önem Derecesi",
            ["ResponsiblePersonnelId"] = "Sorumlu",
            ["EffectivenessVerified"] = "Etkinlik Doğrulandı",
            ["VerifiedByPersonnelId"] = "Doğrulayan",
            ["VerifiedAt"] = "Doğrulama Zamanı",
            ["EffectivenessNote"] = "Etkinlik Notu",
            ["ClosedAt"] = "Kapanma Zamanı",
