...
public sealed class ContactPersonImportHandler : RowImportHandlerBase
{
    ...
    public override IReadOnlyList<ImportTargetFieldDto> GetFields() => new[]
    {
        ...
        new ImportTargetFieldDto("ParentCode", "Cari Kodu",     "string", true,  true,  "Kişinin bağlı olduğu carinin kodu (zorunlu)"),
        new ImportTargetFieldDto("FullName",   "Ad Soyad",      "string", true,  true,  "İletişim kişisinin adı (zorunlu)", MaxLength: 150),
