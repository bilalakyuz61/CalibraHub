    ...
    public static IReadOnlyList<MenuNode> GetMainMenu(bool isSystemAdmin, string? languageCode = null)
    {
        ...
        var settingsChildren = new List<MenuNode>
        {
            ...
            new("settings.companyusers",   isEn ? "User Definitions"       : "Kullanıcı Tanımlamaları", "Users",              "/CompanyUser",              null,
                PermissionFormCode: FormCodes.UserManagement),
        ...
        return new List<MenuNode>
        {
            ...
            new("kalite", isEn ? "Quality Management" : "Kalite Yönetimi", "ShieldCheck", null, new List<MenuNode>
            {
                ...
                new("kalite.capadashboard", isEn ? "CAPA Dashboard" : "DÖF Panosu", "BarChart3", "/Quality/DofDashboard", null,
                    MatchPath: "/Quality/DofDashboard", PermissionFormCode: FormCodes.QualityCapa),
            }),
