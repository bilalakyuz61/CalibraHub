...
public sealed class SqlWaInboxRepository : IWaInboxRepository
{
    ...
    public async Task<IReadOnlyList<WaConversationSummary>> GetConversationsAsync(int limit, CancellationToken cancellationToken)
    {
        ...
        cmd.CommandText = $"""
            ...
            -- Konusma basligi icin sadece GELEN (direction=0) mesajlardan ad cekilir.
            -- Outgoing mesajlardaki pushName = bizim adimizdir, karsi tarafin degil.
            ...
            -- Eslestirme: WaPhone, Mobile, Phone — sadece rakam karsilastir
            OUTER APPLY (
